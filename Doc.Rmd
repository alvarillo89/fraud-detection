...
Para este segundo experimento, se emplearán los dos conjuntos de datos disponibles: `transaction` e `identity`:
...
Convertir cada columna a su tipo de variable correcto. Eliminar el íd también:
